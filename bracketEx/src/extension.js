...
const changeSelection_1 = require("./commands/changeSelection");
...
function activate(context) {
  const changeSelectionCommand = vscode.commands.registerCommand(
    "bracketEx.changeSelection",
    changeSelection_1.changeSelection
  );
  const removeBracketsCommand = vscode.commands.registerCommand(
    "bracketEx.surroundWithInput",
    surroundWithInput_1.surroundWithInput
  );
  const replaceBracketsCommand = vscode.commands.registerCommand(
    "bracketEx.replaceBracketsOrQuotes",
    replaceBracketsOrQuotes_1.replaceBracketsOrQuotes
  );
